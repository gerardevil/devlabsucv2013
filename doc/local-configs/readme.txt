...
2.- view-example.html - una vista de ejemplo mostrando como deber ser el acceso a datos estaticos, desde el proyecto como localhost.
...
[ WARNING ]
- Recuerde que antes de correr el proyecto en el servidor local debe hacer uso del comando 'manage.py syncdb' para mantener su Base de Datos local actualizada.
